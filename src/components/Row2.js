...
function Row2(props) {
  ...
  return (
    <div className="row2container">
      ...
      <Link to="/shop"><div id="earbuds"  className="box"><img name="Earbuds" src="https://as-images.apple.com/is/MME73_AV1?wid=1000hei=1000fmt=jpegqlt=95.v=1632861333000" onClick={handleClick}></img><span><p>Earbuds</p></span></div></Link>
      <Link to="/shop"><div id="tv" className="box"><img src="https://aiwa.com.au/wp-content/uploads/2019/12/AW500.jpg" name="TV" onClick={handleClick}></img><span><p>TVs</p></span></div></Link>
